...
def bump_from_normal(n_map, scale=1, stages=5, iters=1, initial_value=0, verbose=False):
...
def ambient_occlusion(bump_map, n_map, intensity=1, scale=2, bias=0.5, iters=2, verbose=False):
